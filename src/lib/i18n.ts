...
export const DICT = {
  ru: {
    ...
    bizAssetsTitle: "Источники дохода",
    bizAssetAdd: "Добавить",
    bizAssetsEmpty:
      "Добавьте всё, что может приносить деньги: квартиру, инвестицию, клиента, долгий проект или подработку. Это не операции, а карта ваших источников дохода.",
    bizAssetInvestment: "Активы",
    bizAssetRental: "Недвижимость",
    bizAssetFreelance: "Проекты",
    ...
    bizProjectsHowTitle: "Что сюда добавлять",
    bizProjectsHow1:
      "Проект — клиент, заказ, подработка или направление, которое приносит деньги.",
    bizProjectsHow2:
      "Актив — квартира, инвестиция, оборудование или вложенный капитал.",
    bizProjectsHow3:
      "Когда деньги реально пришли — нажмите «В семью», и сумма появится доходом в семейном бюджете.",
    ...
    bizAssetDialogHint:
      "Добавьте источник денег и плановый чистый доход. Для недвижимости можно отдельно указать ЖКХ, для проектов — часы, чтобы увидеть ставку в час.",
  ...
  en: {
    ...
    bizAssetsTitle: "Income sources",
    bizAssetAdd: "Add",
    bizAssetsEmpty:
      "Add everything that can bring money: a flat, investment, client, long project, or side work. This is not a transaction log, but a map of your income sources.",
    bizAssetInvestment: "Assets",
    bizAssetRental: "Real estate",
    bizAssetFreelance: "Projects",
    ...
    bizProjectsHowTitle: "What to add here",
    bizProjectsHow1:
      "Project: client, order, side work, or direction that brings money.",
    bizProjectsHow2: "Asset: flat, investment, equipment, or invested capital.",
    bizProjectsHow3:
      "When money actually arrives, tap “To family” and it will appear as household income.",
    ...
    bizAssetDialogHint:
      "Add a money source and expected net income. For real estate, add utilities separately; for projects, add hours to see hourly rate.",
