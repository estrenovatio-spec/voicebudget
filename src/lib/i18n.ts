...
export const DICT = {
  ru: {
    ...
    moreProjectsHint: "Недвижимость, фриланс, инвестиции — план и перевод в семью",
    projectsExplain:
      "План (₽/мес) — ориентир на карточке. Фактическую сумму вводите при «В семью»: можно изменить, если в этом месяце другая цена. Операция появится во вкладке Семья; удаление там уберёт и запись в истории проекта.",
    ...
    projectsTransferTitle: "Перевод в семейный бюджет",
    projectsTransferHint:
      "Сумма по умолчанию — из плана. Измените, если в этом месяце пришло другое.",
    projectsTransferPlan: "План проекта: {amount}",
    ...
    bizAssetsEmpty: "Инвестиции, аренда, фриланс — добавьте, чтобы видеть доходность.",
    ...
    bizAssetNamePh: "Название: ETF, квартира на Ленина…",
    bizAssetCapitalPh: "Стоимость / капитал, ₽",
    bizAssetMonthlyPh: "Чистыми в месяц, ₽",
    bizAddTx: "Операция",
    ...
    bizProjectsSectionHint:
      "Справочник пассивного дохода. «В семью» — зачисление на семейный баланс, не в доход бизнеса.",
    ...
    bizPortfolioSummary: "Портфель активов",
    ...
    bizAssetDialogHint: "Инвестиции — капитал и купоны/дивиденды. Недвижимость — стоимость и чистый доход. Фриланс — проекты и клиенты.",
    bizPerHour: "ч",
    ...
    bizAssetHoursPh: "Часов в месяц (для ₽/ч)",
  ...
  en: {
    ...
    projectsExplain:
      "Plan (per month) is the guide on the card. Enter the actual amount when tapping «To family» if this month differs. Shows in Family tab; deleting there removes the project history entry too.",
    ...
    projectsTransferTitle: "Transfer to family budget",
    projectsTransferHint: "Default is from the plan. Change if this month’s amount differs.",
    projectsTransferPlan: "Project plan: {amount}",
    ...
    bizAssetAdd: "Add",
    bizAssetsEmpty: "Investments, rental, freelance — add to see yield.",
    ...
    bizAssetNamePh: "Name: ETF, Main St flat…",
    bizAssetCapitalPh: "Value / capital",
    bizAssetMonthlyPh: "Net per month",
    ...
    bizProjectsSectionHint:
      "Passive income catalog. «To account» credits family balance (header «Balance»), not business income.",
    ...
    bizPortfolioSummary: "Asset portfolio",
    ...
    bizAssetDialogHint: "Investments — capital and coupons/dividends. Real estate — value and net income. Freelance — projects and clients.",
    bizPerHour: "h",
    ...
    bizAssetHoursPh: "Hours per month (for $/h)",
