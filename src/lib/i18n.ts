...
export const DICT = {
  ru: {
    ...
    settingsBizQuestionBusinessHint:
      "ИП, ООО, подработка, проекты или отдельные клиенты.",
    settingsBizQuestionPassive: "Есть пассивный доход?",
    settingsBizQuestionPassiveHint:
      "Аренда, проценты, дивиденды, рента, подписки на доходе.",
    ...
    tipsPanelTitle: "Финансовый советник",
    tipsTabAi: "Рост",
  ...
  en: {
    ...
    settingsBizQuestionBusinessHint:
      "Sole trader, LLC, side work, projects, or separate clients.",
    settingsBizQuestionPassive: "Do you have passive income?",
    settingsBizQuestionPassiveHint:
      "Rent, interest, dividends, royalties, or income subscriptions.",
    projectsHistoryYear: "{year}",
    projectsHistoryMonthSummary: "{count} × {total}",
    moreOsago: "Get OSAGO",
    ...
    tipsPanelTitle: "Financial advisor",
    tipsTabAi: "Growth",
    aiTabWeekly: "Weekly",
