...
export const DICT = {
  ru: {
    ...
    householdHint:
      "Первое поле — всегда вы на этом телефоне, второе — партнёр. Менять местами не нужно: облако не подставит имена с другого телефона.",
  ...
  en: {
    ...
    householdHint:
      "First field is always you on this phone, second is your partner. Don’t swap them — cloud won’t copy names from the other device.",
