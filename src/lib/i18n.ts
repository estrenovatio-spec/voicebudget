...
export const DICT = {
  ru: {
    ...
    planningGoalMonthlyPlan: "~{amount}/мес · {months} мес.",
    planningGoalMonthlyPreview: "План: ~{amount}/мес (осталось {months} мес.)",
  ...
  en: {
    ...
    planningGoalMonthlyPlan: "~{amount}/mo · {months} mo left",
    planningGoalMonthlyPreview: "Plan: ~{amount}/mo ({months} months left)",
