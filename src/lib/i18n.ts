...
export const DICT = {
  ru: {
    ...
    moreEducationHint: "18 уроков по финансовой грамотности",
    ...
    educationFormMissing:
      "Ссылка на анкету не задана: NEXT_PUBLIC_DIAGNOSTICS_FORM_URL на Vercel Preview.",
    moreTitle: "Ещё",
    moreSubtitle: "Настройки, отчёты, страхование и рефералы",
    moreReports: "Отчёты",
    ...
    moreServicesTitle: "Страхование и услуги",
    moreInsuranceMenuHint: "ОСАГО, от клеща, ипотека, путешествия",
    ...
    bizCushionTitle: "Подушка безопасности",
    ...
    bizPeriodHint: "Цифры на плашках — за период: {period}. Меняется в блоке «Период» выше.",
    bizFamilyLinkHint: "«В семью» — создаёт доход в семейном бюджете (вкладка Семья).",
    bizCloudOk: "В облаке",
    bizVoiceHint: "Текстом: «расход 5000 реклама», «доход 80000 заказ», «в подушку 10000», «себе 20000»",
    bizVoicePlaceholder: "Напишите операцию…",
    bizVoiceTryManual: "Не понял сумму — попробуйте «расход 5000» или «доход 10000»",
    bizVoiceIncomeOk: "Доход +{amount} ₽ записан",
    bizVoiceExpenseOk: "Расход −{amount} ₽ записан",
    bizVoiceCushionOk: "В подушку: {amount} ₽",
    bizVoiceFamilyOk: "В семью: {amount} ₽",
    bizVoiceFamilyFail: "Недостаточно на счёте бизнеса",
    bizCushionShort: "Подушка",
    ...
    bizCushionGap: "ещё {amount} ₽ до цели",
    ...
    bizAssetDialogHint: "Инвестиции — капитал и купоны/дивиденды. Аренда — стоимость и чистый доход. Фриланс — проекты и клиенты.",
    bizPerHour: "ч",
    ...
    referralWalletStatusPending: "· ждёт оплату",
  ...
  en: {
    ...
    moreEducationHint: "18 financial literacy lessons",
    ...
    educationFormMissing:
      "Form URL not set: NEXT_PUBLIC_DIAGNOSTICS_FORM_URL on Vercel Preview.",
    moreTitle: "More",
    moreSubtitle: "Settings, reports, insurance and referrals",
    moreReports: "Reports",
    ...
    moreServicesTitle: "Insurance & services",
    moreInsuranceMenuHint: "OSAGO, tick cover, mortgage, travel",
    moreOsago: "Get OSAGO",
    ...
    bizCushionTitle: "Safety cushion",
    ...
    bizPeriodHint: "Tile numbers use period: {period}. Change in Period controls above.",
    bizFamilyLinkHint: "«To family» creates income in household budget (Family tab).",
    bizCloudOk: "Cloud saved",
    bizVoiceHint: "Text: «expense 500 ads», «income 8000 order», «cushion 1000», «family 2000»",
    bizVoicePlaceholder: "Type a transaction…",
    bizVoiceTryManual: "Could not parse amount — try «expense 500» or «income 1000»",
    bizVoiceIncomeOk: "Income +{amount} recorded",
    bizVoiceExpenseOk: "Expense −{amount} recorded",
    bizVoiceCushionOk: "To cushion: {amount}",
    bizVoiceFamilyOk: "To family: {amount}",
    bizVoiceFamilyFail: "Not enough on business account",
    bizCushionShort: "Cushion",
    ...
    bizCushionGap: "{amount} to target",
    ...
    bizAssetDialogHint: "Investments — capital and coupons/dividends. Rental — value and net income. Freelance — projects and clients.",
    bizPerHour: "h",
    ...
    referralWalletStatusPending: "· awaiting payment",
