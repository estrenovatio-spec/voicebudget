...
export const DICT = {
  ru: {
    ...
    myNamePlaceholder: "Ваше имя в балансе",
    myNameSave: "Сохранить моё имя",
    partnerNamePlaceholder: "Имя партнёра в балансе",
    ...
    planningRecurringHint:
      "Шаблон повторяющегося расхода. При открытии приложения, если наступила дата, сумма сама попадёт в список операций. «Приостановить» — записи не создаются, шаблон остаётся.",
  ...
  en: {
    ...
    planningRecurringHint:
      "Recurring expense template. When you open the app and the date is due, it is added to your transactions. Pause stops new entries; the template stays.",
