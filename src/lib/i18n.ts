...
export const DICT = {
  ru: {
    ...
    balanceTapHint: "Нажмите на сумму — можно исправить «сколько в кармане»",
    balanceTapHintPartner: "Нажмите на свою сумму или партнёра",
    income: "Доход",
    expense: "Расход",
    settings: "Настройки",
    ...
    helpChatTitle: "Спросить ИИ",
    helpChatHint:
      "По приложению и по вашим тратам. С облаком ответ строится по базе на сервере.",
    helpChatPlaceholder:
      "Например: как пригласить партнёра? Сколько потратил на еду за месяц?",
    helpChatSend: "Спросить",
    helpChatThinking: "Ищу ответ…",
    helpChatEmpty: "Задайте вопрос — ИИ видит FAQ и ваши операции (из облака или с телефона).",
    helpChatLimit: "Лимит вопросов в этой сессии. Закройте и откройте справку снова.",
    ...
    voiceHint: "Нажмите → говорите → нажмите ещё раз",
    ...
    tipsTabDragHint: "Перетащите вкладки за ≡ — порядок сохранится",
    ...
    monthlySubtitleWaiting: "Отчёт с первого входа — нужно 5+ операций; обновление раз в 30 дней",
    ...
    donationLine: "Отблагодарить тёщу автора: Сбер 2202208434065638 (Ольга Валерьевна Я)",
    ...
    planningInputHint:
      "Копилка: «закинул 2000 на отпуск» — спишется с баланса и попадёт в цель. Доход: «зарплата 10000, 2000 на отпуск».",
  },
  en: {
    appTitle: "VoiceBudget",
    balance: "Balance",
    ...
    balanceTapHint: "Tap the amount to set cash on hand",
    balanceTapHintPartner: "Tap your amount or partner's",
    income: "Income",
    expense: "Expense",
    settings: "Settings",
    ...
    helpChatHint:
      "About the app and your spending. With cloud on, answers use the server database.",
    helpChatPlaceholder:
      "e.g. How do I invite my partner? How much did I spend on food this month?",
    helpChatSend: "Ask",
    helpChatThinking: "Thinking…",
    helpChatEmpty: "Ask a question — AI uses the FAQ and your transactions (cloud or this device).",
    helpChatLimit: "Question limit for this session. Close and reopen help to reset.",
    ...
    tipsTabDragHint: "Drag tabs by ≡ — order is saved",
    ...
    donationLine: "Support the author's mother-in-law: Sber 2202208434065638 (Olga Valeryevna Ya)",
    ...
    planningInputHint:
      "Jar: «put 2000 toward vacation» — balance down, goal up. Income: «salary 10000, 2000 for vacation».",
  },
} as const;
