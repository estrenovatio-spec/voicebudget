...
export const FAQ_SECTIONS: FaqSection[] = [
  ...
  },
  {
    ...
    body: {
      ru: [
        "Вкладка «Рост»: миссия недели, «Финансовая память», «Финсоветник заметил», разборы 7/30 дней.",
        "Миссия недели — маленькое действие для финансовой привычки, а не просто совет.",
        "«Финансовая память» запоминает ваши фразы, категории и исправления.",
...
export const FAQ_CHEATSHEET_SECTIONS: FaqCheatsheetSection[] = [
  ...
  },
  {
    ...
    steps: {
      ru: [
        "«Рост» — миссия недели, «Финансовая память», «Финсоветник заметил» и разборы 7/30 дней.",
        "Миссия недели учит одной финансовой привычке через маленькое действие.",
        "«Финансовая память» показывает, какие слова и исправления приложение запомнило.",
      ],
      en: [
        "Growth: weekly mission, Financial memory, advisor notes, 7/30-day reviews.",
