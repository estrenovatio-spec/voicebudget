...
import { deleteCloudCategory } from "@/lib/household/service";
...
export async function DELETE(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    await deleteCloudCategory(session.userId, session.householdId, params.id);
    ...
    if (e.message === "cannot_delete_system") {
